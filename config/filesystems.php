...
return [
    ...
    */
    ...
    'disks' => [
        ...
        /*
         * Generated report files (spec §39). Private, like every other disk
         * holding client data: an export is a snapshot of someone's spend and
         * conversions, and the only route to it is an authorised controller.
         */
        'reports' => [
            'driver' => env('REPORTS_DISK_DRIVER', 'local'),
